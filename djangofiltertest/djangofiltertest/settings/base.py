...
ROOT_URLCONF = 'djangofiltertest.urls'
...
LOCAL_APPS = (
    'djangofiltertest.apps.authentication.apps.AuthenticationConfig',
    'djangofiltertest.apps.posts.apps.PostsConfig',
    'djangofiltertest.apps.posts_areas.apps.PostsAreasConfig',
)
...
WSGI_APPLICATION = 'djangofiltertest.wsgi.application'
